...
public class TaskController {
    ...
    public void save(Task task) {
        ...
        try {
            ...
            //Setando os valores das interrogações da string.
            statement.setInt(1, task.getIdProject());
            statement.setString(2, task.getName());
            statement.setString(3, task.getDescription());
            statement.setBoolean(4, task.isIsCompletd());
    ...
    public void update(Task task) {
        ...
        try {
            ...
            //Setano os valores do statement.
            statement.setInt(1, task.getIdProject());
            statement.setString(2, task.getName());
            statement.setString(3, task.getDescription());
            statement.setString(4, task.getNotes());
            statement.setBoolean(5, task.isIsCompletd());
            statement.setDate(6, new Date(task.getDeadline().getTime()));
            statement.setDate(7, new Date(task.getCreatedAt().getTime()));
            statement.setDate(8, new Date(task.getUpdatedAt().getTime()));
    ...
    public List<Task> getAll(int idProject) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                task.setIsCompletd(resultSet.getBoolean("completed"));
